...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "E://gpy//centernet_relative_kitti-paixu//img_out//transformed_images/"
    dir_save_path   = "E://gpy//centernet_relative_kitti-paixu//img_out//transformed_images_output/"
    #-------------------------------------------------------------------------#
